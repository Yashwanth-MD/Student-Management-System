...
<head> 
    ...
    <style> 
        ...
        @media (max-height: 800px) { 
            .password-container { margin: 10px auto; } 
            .logo-section { padding: 20px 15px; } 
            .form-section { padding: 20px; } 
        } 
         
        @media (max-width: 576px) { 
            .password-container { border-radius: 15px; } 
        ...
        <div class="password-container"> 
            <div class="logo-section"> 
                <div class="logo-img"> 
                    ...
                    <img src="https://play-lh.googleusercontent.com/8ZDxwWHQnKPHu3hJDN0whQqz8PDtpH1niWl_s6NIJ1Xitu612zFbYJRif8Dv8wisBg" alt="Logo"> 
                </div> 
