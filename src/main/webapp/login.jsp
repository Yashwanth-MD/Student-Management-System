        ...
        <div class="login-container">
            <div class="logo-section">
                <div class="logo-img">
                    ...
                    <img src="https://playlh.googleusercontent.com/8ZDxwWHQnKPHu3hJDN0whQqz8PDtpH1niWl_s6NIJ1Xitu612zFbYJRif8Dv8wisBg" alt="Student Management System Logo">
                </div>
                <h2>Pentagon Space Pvt.Ltd.</h2>
                <p class="mb-0">Student Login Page</p>
            </div>
            ...
            <div class="form-section">
                ...
                <div class="signup-link">
                    <p>Don't have an account? 
                        <a href="signup.jsp" class="text-decoration-none fw-bold">Sign up here</a>
                    </p>
                </div>
            </div>
        </div>
